...
static const clap_plugin_descriptor_t DESC = {
    ...
    .url = "https://github.com/akindoflikeness/bypomono",
    .manual_url = "https://github.com/akindoflikeness/bypomono",
    .support_url = "https://github.com/akindoflikeness/bypomono",
    .version = APP_VERSION,
