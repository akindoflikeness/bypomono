...
typedef enum {
    V_RECORD, V_REPORT, V_SAVE, V_OVERWRITE, V_DELETE, V_RENAME, V_MOVE,
...
static const Spec ROSTER[] = {
    ...
    {"report", NULL, V_REPORT, "photograph the frame and open a note about it",
     {NULL, NULL}, 0, 0, NULL, 0, false},
};
...
static void cmd_echo(const Cmd *c, char *out, size_t cap) {
    ...
    case V_REPORT: snprintf(out, cap, "report"); break;
    }
}
